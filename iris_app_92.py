...
s_length = st.slider("Sepal Length" , 0 , 10)
s_width = st.slider("Sepal width" , 0 , 10)
p_length = st.slider("Petal Length" , 0 , 10)
p_width = st.slider("Petal width" , 0 , 10)

if st.button("Predict"):
	predicted_species = prediction(s_length , s_width , p_length , p_width)
